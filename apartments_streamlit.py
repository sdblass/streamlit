...
st.write(
'''
## Enter your hourly wage ($ per hour). This will let us determine how much your time spent commuting is worth to you which we will factor in to the rents.
''')

hourly_income = st.number_input('Hourly wage')

st.write('''
## Enter your anticipated average commuting speed. Default is 40 mph.
''')
...
def get_geocoords(address=address):
    ...
    url = f'https://api.mapbox.com/geocoding/v5/mapbox.places/{workplace}.json?access_token={mapbox_access_token}'
